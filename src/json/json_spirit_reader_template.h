...
{
    const spirit_namespace::int_parser < int64_t >  int64_t_p  = spirit_namespace::int_parser < int64_t  >();
    const spirit_namespace::uint_parser< uint64_t > uint64_t_p = spirit_namespace::uint_parser< uint64_t >();
    ...
    public:
        ...
        public:
            ...
            definition( const Json_grammer& self )
            {
                ...
                typedef boost::function< void( uint64_t )      > Uint64_t_action;
