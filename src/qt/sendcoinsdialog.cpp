    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a TravelFlex address (e.g. Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
#endif
...
void SendCoinsDialog::setBalance(qint64_t balance, qint64_t unconfirmedBalance, qint64_t immatureBalance)
{
